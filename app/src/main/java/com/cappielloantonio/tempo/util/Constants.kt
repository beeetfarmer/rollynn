...
object Constants {
    ...
    const val PLAYLIST_FOLDER_OBJECT = "PLAYLIST_FOLDER_OBJECT"
    const val PLAYLIST_FOLDER_ID = "PLAYLIST_FOLDER_ID"
    ...
    const val ARTIST_RECENTLY_PLAYED = "ARTIST_RECENTLY_PLAYED"
    const val ARTIST_TOP_PLAYED = "ARTIST_TOP_PLAYED"
    ...
    const val MEDIA_TOP_PLAYED = "MEDIA_TOP_PLAYED"
    ...
    const val MEDIA_DEFAULT_ORDER = "MEDIA_DEFAULT_ORDER"
    ...
    const val HOME_SECTOR_HISTORY = "HOME_SECTOR_HISTORY"
    const val HOME_SECTOR_RECENTLY_PLAYED_ARTISTS = "HOME_SECTOR_RECENTLY_PLAYED_ARTISTS"
    const val HOME_SECTOR_TOP_PLAYED_ARTISTS = "HOME_SECTOR_TOP_PLAYED_ARTISTS"
    const val HOME_SECTOR_TOP_PLAYED_SONGS = "HOME_SECTOR_TOP_PLAYED_SONGS"
